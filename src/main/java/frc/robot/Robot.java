...
public class Robot extends TimedRobot {
    ...
    public static DriveTrainSubsystem DriveSub;
    ...
    public void robotInit() {
        ...
        potentiometer = new AnalogPotentiometer(3, 90, 45);
        //tilted = new Servo(9);
    ...
    public void autonomousInit() {
        ...
        // color = DriveStation.getAlliance();

        // int station;
        // station = DriveStation.getLocation();
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        pos = potentiometer.get();
        SmartDashboard.putNumber("Potentiometer", pos);
        // double angle = tilted.getPosition();
